...
uniqueSpecies = species.scientific_name.nunique()
print uniqueSpecies
...
categoryValues = species.category.unique()
...
countByConservationStatus = species.groupby("conservation_status").count()
print countByConservationStatus
